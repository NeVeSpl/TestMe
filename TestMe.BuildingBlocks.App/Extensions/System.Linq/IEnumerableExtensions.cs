...
namespace System.Linq
{
    public static class IEnumerableExtensions
    {
                                                   ...
                                                   where TId : notnull
        {
            ...
            Dictionary<TId, Match<TTargetItem, TSourceItem>> matches = targetCollection.ToDictionary(targetItemIdSelector, x => new Match<TTargetItem, TSourceItem>(x, default, ActionType.Delete));
        ...
        private class Match<TTargetItem, TSourceItem> where TSourceItem : class
                                                      where TTargetItem : class
        {
